...
namespace MDI_Ventas
{
    public partial class Form1 : Form
    {
        ...
        {
            Frm_Lista_Precios listaprecios = new Frm_Lista_Precios();
        ...
        {
            Frm_Movimiento_Clientes clientesmov = new Frm_Movimiento_Clientes();
            clientesmov.StartPosition = FormStartPosition.CenterScreen;
            clientesmov.MdiParent = this;
            clientesmov.Show();
        }

        private void ComisionesToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            Frm_Comision comision_frm = new Frm_Comision();
            comision_frm.StartPosition = FormStartPosition.CenterScreen;
            comision_frm.MdiParent = this;
            comision_frm.Show();
        }

        private void PolizasToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Frm_Polizas poliza = new Frm_Polizas();
            poliza.StartPosition = FormStartPosition.CenterScreen;
